...
{
	private JLabel userIdLabel,nameLabel, emailLabel, phoneNoLabel, genderLabel, ageLabel, addressLabel, securityQuesLabel, securityAnsLabel, passLabel, discountPercentageLabel,membershipTypeLabel,imageLabel;
	...
	public CustomerOperationFrame(User u)
	{
		...
		String customerData1[][]=new String[customerList.length][8];
		for(int i=0;i<customerList.length;i++)
		{
			...
			if(customerList[i]!=null)
			{
				...
				customerData1[i][7]=customerList[i].getMembershipType();
			}
		...
		String head1[]={"Id","Name","Email","PhoneNo","Gender","Age","Address","Membership Type"};
		
		this.customerTable=new JTable(customerData1,head1);
		
		this.customerTableSP=new JScrollPane(customerTable);
		this.customerTableSP.setBounds(50,380,700,200);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			String userId,name,gender,email,phoneNo,address,securityAns,password,membershipType;
			int age;
			...
			if((!userTF.getText().isEmpty()) && (!nameTF.getText().isEmpty()) && (!emailTF.getText().isEmpty()) && (!phoneNoTF.getText().isEmpty()) &&((maleRB.isSelected()) || (femaleRB.isSelected())) && (!ageTF.getText().isEmpty()) && (!addressTF.getText().isEmpty())&& (!securityAnsTF.getText().isEmpty()) && (!passPF.getText().isEmpty()))
			{
				...
				if(user==null)
				{
					try
					{
						...
						Customer a=new Customer(userId,name,gender,email,phoneNo,address,securityAns,password,age,role,null,membershipType);
		...
		if(command.equals(searchBtn.getText()))
		{
			...
			if(!userTF.getText().isEmpty())
			{
				...
				if(a!=null)
				{
					...
					if(a.getMembershipType().equals("Normal"))
                    {
                        membershipTypeCMB.setSelectedItem("Normal");
                    }
                    else
                    {
                        membershipTypeCMB.setSelectedItem("Premium");
                    }
