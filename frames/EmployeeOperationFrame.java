...
{
	private JLabel userIdLabel,nameLabel, emailLabel, phoneNoLabel, genderLabel, ageLabel, addressLabel, securityQuesLabel, securityAnsLabel, passLabel, designationLabel,imageLabel;
	...
	public EmployeeOperationFrame(User u)
	{
		...
		String[] item={"Chef", "Waiter"};
		this.designationCMB=new JComboBox(item);
		this.designationCMB=new JComboBox(item);
		this.designationCMB.setBounds(390,250,100,30);
		...
		String employeeData1[][]=new String[employeeList.length][8];
		...
		String head1[]={"Id","Name","Email","PhoneNo","Gender","Age","Address","Designation"};
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			String userId,name,gender,email,phoneNo,address,securityAns,password,designation,salary;
			int age;
			...
			if((!userTF.getText().isEmpty()) && (!nameTF.getText().isEmpty()) && (!emailTF.getText().isEmpty()) && (!phoneNoTF.getText().isEmpty()) &&((maleRB.isSelected()) || (femaleRB.isSelected())) && (!ageTF.getText().isEmpty()) && (!addressTF.getText().isEmpty())&& (!securityAnsTF.getText().isEmpty()) && (!passPF.getText().isEmpty()))
			{
				...
				if(user==null)
				{
					try
					{
						...
						Employee a=new Employee(userId,name,gender,email,phoneNo,address,securityAns,password,age,role,designation,null);
		...
		if(command.equals(searchBtn.getText()))
		{
			...
			if(!userTF.getText().isEmpty())
			{
				...
				if(a!=null)
				{
					...
					if(a.getDesignation().equals("Chef"))
                    {
